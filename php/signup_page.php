        ...
        <div class="signup container">
            ...
            <div class="form">
                <form method="POST" action="">
                    ...
                    <input type="text" class="new_email" placeholder="example@hotmail.com">
                    <label><h4>New password:</h4></label>
                    <input type="password" class="new_password" placeholder="password">
                </form>
            </div>
            <div class="footer">
                <button class="signup_btn">Create my checklist</button>
            </div>
        </div>
